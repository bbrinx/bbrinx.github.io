        ...
        <main className="main dashed-line">
            ...
            <div className="bio-text">
              ...
              <div className={`text ${this.state.tldr ? 'hidden' : ''}`}>
                <p>
                  ...
                  To be sure I was on the right path, I completed an <span className="tldr">internship</span>as a <span className="tldr">web developer</span> <span className="footnote">[1]</span>. 
                ...
                <p>
                  In October I moved to Berlin to <span className="tldr">study international media and computing</span> <span className="footnote">[2]</span>, 
                  a computer science major with focus on image processing and web development. 
                  While studying I was <span className="tldr">awarded with the Deutschland Stipendium</span>, a scholarship for high-achieving students <span className="footnote">[3]</span>. 
                ...
                <p>
                  From March until August 2017 I worked as a <span className="tldr">full stack development intern at Decidata</span>, a marketing startup <span className="tldr">in Mexico City</span><span className="footnote">[4]</span>. 
                ...
                <p>
                  During my last two semesters I worked as a <span className="tldr">full stack developer</span> at the <span className="tldr">Berlin</span> startup <span className="tldr">Foodly</span><span className="footnote">[5]</span>. 
          ...
          <div className="projects">
            <div className="projects-text">
              ...
              <div className={`text ${this.state.tldr ? 'hidden' : ''}`}>
                <p>
                  One of my favorite projects I worked on was my <span className="tldr">semester project</span> <span className="footnote">[1]</span>. 
                ...
                <p>
                  Another important project for me was my <span className="tldr">bachelor thesis</span> <span className="footnote">[2]</span>. 
                ...
                <p>
                  ...
                  This resulted in a small <span className="tldr">news reader</span>, called simple newsfeed, built with <span className="tldr">React.js and Node.js</span>  <span className="footnote">[3]</span>. 
